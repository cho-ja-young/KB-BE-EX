//package Study.src.ch17.question.q1;
//
...
//        // 결과 : 약 8.7
//        double avg = Arrays.stream(movies)
//                .filter(movie -> movie == "SF")
//                .
//
//
...
//                // .sorted((mov1, mov2) -> Double.compare(mov2.getRating(), mov1.getRating()))
//                .sorted(Comparator.comparing(Movie::getRating).reversed())
//                .map(movie ->movie.getTitle())
//                .toList();
//        System.out.println("2. 2010년 이후 개봉된 영화를 평점 내림차순으로 정렬하여 제목 리스트를 반환 : " + answer2);
//
...
//                .sorted()
//                .toList();
//        System.out.println("5. 평점이 8.5 이상인 영화들의 장르를 중복 없이 알파벳 순으로 정렬하여 반환 : " + answer5);
//    }
//}
